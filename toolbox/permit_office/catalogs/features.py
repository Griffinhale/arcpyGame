...
FEATURE_ARCHETYPES: dict[str, FeatureArchetype] = {
    ...
    "utility_backbone": FeatureArchetype(
        ...
        coverage_effects={"risk": -1, "services": 2},
...
FEATURE_OPERATING_RULES: dict[str, FeatureOperatingRule] = {
    "arterial_road": FeatureOperatingRule("arterial_road", revenue_per_turn=1, upkeep_per_turn=1, decay_per_turn=1, maintenance_interval=6, maintenance_cost=6, repair_amount=35, failure_effects={"prosperity": -1, "unrest": 1}),
    "utility_backbone": FeatureOperatingRule("utility_backbone", upkeep_per_turn=2, decay_per_turn=1, maintenance_interval=6, maintenance_cost=8, repair_amount=45, failure_effects={"risk": 3, "unrest": 1}),
    "neighborhood_park": FeatureOperatingRule("neighborhood_park", upkeep_per_turn=1, decay_per_turn=1, maintenance_interval=6, maintenance_cost=5, repair_amount=30, failure_effects={"risk": 1, "culture": -1}),
