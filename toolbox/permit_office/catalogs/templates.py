...
TEMPLATES: dict[str, DocketTemplate] = {
    ...
    "business_license_fee_sweep": DocketTemplate(
        ...
        mitigation_cost=3,
        expires_after=1,
        preview="Collects overdue license fees from a commercial node; modest irritation buys near-term budget recovery.",
        inspect_hint="The ledger is unusually legible, and several renewals are ready to become receipts.",
        ...
        contact_name="Revenue Examiner Tessa Folio",
    ...
    "compliance_settlement_drive": DocketTemplate(
        ...
        mitigation_cost=4,
        expires_after=1,
        preview="Settles low-grade violations into payment plans; helps the budget later without erasing compliance risk.",
        inspect_hint="Most parties would rather pay than attend another hearing, which is administratively useful.",
        ...
        growth_groups=("civil_servants",),
        contact_name="Settlement Officer Omar Receipt",
