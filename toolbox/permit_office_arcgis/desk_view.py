...
class PermitDeskView:
    ...
    def _draw_status_panel(self, c, box):
        ...
        lines = _fit_lines(self.model.status_text or "No report yet.", max(20, (x1 - x0 - 28) // 7), 4)
...
def _action_note(template) -> str:
    ...
    if template.is_incident:
        return "Issue=response; Conditions=settlement; Deny=defer incident."
    if template.is_enforcement:
        return "Issue=enforce; Conditions=settle; Deny=defer."
